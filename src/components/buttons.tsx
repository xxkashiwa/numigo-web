...
const NewChatButton = () => {
  ...
  return (
    <button
      className="flex items-center gap-2 rounded-lg bg-gray-100 bg-opacity-50 px-4 py-2 shadow-md transition-all duration-300 hover:bg-gray-200"
      onClick={newChat}
    >
      <svg
...
const ToggleButton = () => {
  ...
  return (
    <button
      className="flex items-center justify-center rounded-lg bg-gray-100 bg-opacity-50 p-2 shadow-md transition-all duration-300 hover:bg-gray-200"
      onClick={() => {
        toggleSidebar();
      }}
    >
